  ...
  for(k=1;k<=(N-1);k++)
   for(i=1;i<=(M-1);i++){
    ...
    C[i][0][n+1]=C[i][0][n]+rr*(C[i+1][0][n]-2*C[i][0][n]+C[i-1][0][n])
                 +(rr/(2*i))*(C[i+1][0][n]-C[i-1][0][n])+rz*2.0*(C[i][1][n]-C[i][0][n]);
